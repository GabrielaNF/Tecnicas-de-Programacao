...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Data> registros; //declara um objeto do tipo arrayList que so aceita receber dados do tipo Data
        registros = new ArrayList<Data>();//instancia objeto

        //registros.add();//aceita apenas dados do tipo Data
        ...
        registros.add(diaDoTrabalho); //funciona pois feriado eh filho da data
